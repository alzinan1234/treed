...
const Footer = () => {
    return (
        <div className=' '>
            <div className='  '>
            <section className="  lg:pt-52 bg-[radial-gradient(circle,_#8B5CF6_0%,_#0D0D0D_70%)] flex flex-col items-center justify-center">
                <div className="absolute z-50 -mt-200 lg:-mt-250 mx-auto">
                    <div className='mt-52 lg:mt-0'>
                        <h2 className="text-4xl text-center md:text-5xl font-bold my-10">
                            Treedi is Now Available
                        </h2>
                            <p className="w-2/3 mx-auto text-lg text-center mb-6 text-[#B0B0B0]">
                            Treedi is ready to download as we prepare to launch our first service. This app is built to change your life
                        </p>
                    </div>
            ...
            <footer className=" relative z-30 bg-[#161616] text-white px-6 -mt-70 lg:-mt-100 border  ">
                ...
                <div>
                    <h1 className="lg:text-[340px] text-7xl text-center text-[#8E8D94] font-bold ">
                        Treedi
                    </h1>
                </div>
            </footer>
