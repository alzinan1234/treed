    ...
    return (
        <div className='py-10 px-4'>
            ...
            <div className="flex flex-col items-center my-5 text-white">
                <h1 className="lg:w-5/11 mb-5 text-xl md:text-5xl font-bold text-center">                   
                    We're Starting in 85+ Cities
                — And Going Everywhere
                </h1>
                <p className="mb-5 max-w-2xl text-[#B0B0B0] text-center text-base md:text-xl">
                    We’re first deploying Road Data Collectors in over 85 cities across Canada. But this is just the beginning — we’ll soon expand to every place.
                </p>
            </div>
            ...
            >
                ...
                <div className="w-full px-4 md:px-0 ">
                    <label className="relative w-full max-w-xl mx-auto block -mt-32 md:-mt-40">
                        ...
                        <input
                            type="search"
                            className="w-full pl-12 pr-4 py-4 bg-[#161616] bg-cover bg-center text-white rounded-full shadow-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#9155F7]"
