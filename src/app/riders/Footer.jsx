            ...
            <section className=" min-h-screen lg:pt-52 bg-[radial-gradient(circle,_#8B5CF6_0%,_#0D0D0D_70%)] flex flex-col items-center justify-center">
                <div className="absolute z-50 -mt-200 lg:-mt-250 mx-auto">
                    <div className='mt-52 lg:mt-0'>
                        <h2 className="text-2xl text-center md:text-5xl font-bold my-10">
                            Download and Get Ready
                        </h2>
                        <p className="w-2/3 mx-auto text-lg text-center mb-6 text-[#B0B0B0]">
                            Download Treedi now to know exactly when you'll be able to connect with Road Data Collectors and start moving
                        </p>
                    </div>
                ...
                {/* Phones Image */}
                <div className="relative z-20 flex justify-center lg:mt-[600px] mt-[25rem]">
                    <img
